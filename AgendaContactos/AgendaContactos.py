...
class Amigo(Persona):
    """Esta clase hereda de la clase persona y tendra una lista que se rellenera con objetos de esta clase"""
...
def GuardarBaseDatos():
    ...
    conector.close()
def CargarBaseDatos():
    """Este metodo se encargara de mediante una consulta rellenar las listas con los datos que hay ingresados en la base de datos"""
    import sqlite3
    conector = sqlite3.connect("AgendaContactos.db")
    cursor = conector.cursor()
